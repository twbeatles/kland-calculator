...
[![Version](https://img.shields.io/badge/Version-4.4.0-blue)](package.json)
...
프로젝트에는 **130개 이상의 전문 계산기**가 포함되어 있으며, 다음 카테고리로 구성됩니다:

#### 💻 계산 도구
평수계산, 전환계산, 매물비교, 수익률목표, BEP계산, 역세권 프리미엄, **월세세액공제**, **취득세감면**, **상속플래너** 등

#### 💳 금융 도구
은행금리, 고정vs변동, 스트레스테스트, **중도상환비교**, 신용점수, 보증보험, 조기상환, **주담대갈아타기**, **DSR스트레스**, **전세보증비교**, **신용개선** 등
...
#### 📊 분석 도구 (신규)
**오피스텔 vs 아파트**, **빌라 리스크 체커**, **매매 타이밍 분석**, **부부 합산 보유세 분석** 등

#### 👶 생애주기/권리진단 (신규)
**신혼부부 주거지원 체크리스트**, **국민/민영주택 구분 가이드**, **임차인 권리 체크리스트**, **1세대1주택 비과세 판정** 등
...
### v4.4.0 (2026.01.29) - 편의성 고도화 업데이트

#### 🆕 신규 계산기 추가 (+6개)
- **임차인 권리 체크리스트**: 주임법 기반 대항력/우선변제권 및 계약갱신청구권 필수 체크
- **취득세 감면 도우미**: 생애최초/신혼부부/출산가구 감면 자격 및 절세액 계산
- **1세대 1주택 비과세 판정**: 12억 기준, 보유/거주 기간별 비과세 및 과세대상 상세 판정
- **중도상환수수료 비교**: 5대 시중은행 및 인터넷은행 수수료 비교 및 면제 시점 안내
- **주담대 갈아타기 시뮬레이터**: 중도상환수수료 포함 총 비용 vs 이자 절감액 손익분기 분석
- **부부 공동명의 보유세 분석**: 공시가격별 단독 vs 공동명의 종부세/재산세 비교 분석

#### 🎨 개선사항
- 전세사기 예방 기능 강화 (체크리스트 추가)
- 금융 분석 도구 정밀도 향상
- Constants 업데이트 (2026년 최신 세율 및 수수료율 반영)
...
130개 이상의 계산기를 빠르게 찾을 수 있는 통합 검색 기능
